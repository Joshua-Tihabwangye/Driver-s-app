...
// EVzone Driver App – RideRequestsPrompt Driver – Ride Requests Prompt (v2)
// Small prompt card encouraging the driver to open the Ride Requests screen (RideRequestsList).
