          ...
          <div className="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 flex items-center justify-center">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col items-center">
                <span className="text-[10px] tracking-[0.2em] font-black uppercase text-emerald-100/70 text-nowrap">Driver · Ride Sharing</span>
                <p className="text-base font-black text-white tracking-tight leading-tight text-center">Additional requests</p>
              </div>
            </div>
          </div>
          <div className="w-10" />
