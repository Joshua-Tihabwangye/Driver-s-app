...
// EVzone Driver App – JobTypesLegend Job Types & Icons Legend (v2)
...
// - Optional Help link for Shuttle that can open the Shuttle Link Info screen (ShuttleLinkInfo).
...
export default function JobTypesLegend() {
