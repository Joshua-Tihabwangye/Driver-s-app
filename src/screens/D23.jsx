...
// EVzone Driver App – D23 Preferences – Quiz Passed Confirmation (v1)
// Confirmation screen shown after the driver passes the quiz.
...
export default function QuizPassedConfirmationScreen() {
        ...
        <main className="flex-1 px-4 pb-4 space-y-4 overflow-y-auto scrollbar-hide">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm font-semibold">
                  You passed the info session quiz.
                </p>
              </div>
            </div>
            <p className="text-[11px] text-slate-100 leading-snug">
              You&apos;ve shown a good understanding of how EVzone works for
              drivers and how to keep your earnings and safety on track.
            </p>
            <div className="flex items-center space-x-2 text-[10px] text-emerald-300">
              <Star className="h-3.5 w-3.5" />
              <span>Score example: 3 / 3 correct</span>
            </div>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="space-y-1.5 text-[11px] text-slate-600">
              <li>• Recognize how EVzone trips and deliveries are assigned.</li>
              <li>• Plan around peak hours and use surge zones safely.</li>
              <li>• Use ratings and support tools when you need help.</li>
            </ul>
          </section>
          ...
          <section className="pt-1 pb-4 flex flex-col space-y-2">
            ...
            <p className="text-[10px] text-slate-500 text-center">
              You can re-take this quiz any time from Preferences → Training &
              learning.
            </p>
          </section>
        </main>
