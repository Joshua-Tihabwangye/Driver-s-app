...
export default function Login() {
  ...
  return (
    <PhoneFrame>
      <div className="px-8 pt-10 pb-8 flex flex-col h-full bg-white">
        {/* Back Button */}
        <button 
          onClick={() => navigate(-1)}
        ...
        <div className="mt-8 mb-4">
          ...
          <button className="w-full border-2 border-slate-100 rounded-2xl py-5 flex items-center justify-center space-x-4 hover:bg-slate-50 active:scale-[0.98] transition-all group">
        ...
        <p className="text-center text-[11px] text-slate-500 font-bold uppercase tracking-wide">
          New here? <button onClick={() => navigate("/app/home")} className="text-[#03cd8c] font-black hover:underline">Register Fleet</button>
        </p>
      </div>
    </PhoneFrame>
  );
