...
// EVzone Driver App – D24 Preferences – Content Completion Screen (v1)
// Generic "module completed" screen shown after finishing a training module or content.
        ...
        <main className="flex-1 px-4 pb-4 space-y-4 overflow-y-auto scrollbar-hide">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm font-semibold">
                  Thanks for exploring this content.
                </p>
              </div>
            </div>
            <p className="text-[11px] text-slate-100 leading-snug">
              You&apos;ve finished this learning module. You can review it again at
              any time, or move on to the next topic in your driver training
              journey.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="space-y-1.5 text-[11px] text-slate-600">
              <li>• Start the next recommended training module.</li>
              <li>• Revisit this module if you want a quick refresher.</li>
              <li>• Apply what you&apos;ve learned in your next trips and deliveries.</li>
            </ul>
          </section>
          ...
          <section className="pt-1 pb-4 flex flex-col space-y-2">
            ...
            <p className="text-[10px] text-slate-500 text-center">
              You can always find completed content in Preferences → Training &
              learning.
            </p>
          </section>
        </main>
