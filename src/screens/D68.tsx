        ...
        <section className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 bg-slate-200 h-[220px] shadow-lg">
          ...
          <div className="absolute left-[20%] bottom-[20%] flex flex-col items-center">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-slate-900 shadow-xl border-2 border-white transform rotate-45">
              <Navigation className="h-5 w-5 text-[#03cd8c] transform -rotate-45" />
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="rounded-[2rem] border border-slate-100 bg-white p-5 flex items-center justify-between shadow-sm">
              <div className="flex items-center space-x-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50">
                  <Camera className="h-6 w-6 text-[#03cd8c]" />
                </div>
              ...
              <button
                ...
                className="rounded-2xl bg-slate-900 px-5 py-2.5 text-[10px] font-black uppercase tracking-widest text-white active:scale-95 transition-all shadow-md"
              >
                Add ({photosCount})
              </button>
            </div>
            ...
            <div className="rounded-[2rem] border border-slate-100 bg-white p-5 flex items-center justify-between shadow-sm">
              <div className="flex items-center space-x-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50">
                  <FileText className="h-6 w-6 text-[#03cd8c]" />
                </div>
                <div className="flex flex-col items-start px-2">
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-900">
                    Add Note
