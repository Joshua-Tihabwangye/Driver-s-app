...
// EVzone Driver App – TripCompletion Driver – Arrived / Trip Completion Screen (v3)
// Trip completion screen now accepts an optional initialJobType prop so it can be
// opened directly for a specific job type (e.g. jobType="ambulance" from AmbulanceJobStatus).
...
export default function TripCompletion({ initialJobType = "ride" }) {
