...
function ApprovedRow({ icon: Icon, title, subtitle }) {
  return (
    <div className="flex items-center justify-between rounded-2xl border border-blue-100 bg-blue-50 px-3 py-2.5 shadow-sm">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="text-[11px] text-blue-700">{subtitle}</span>
        </div>
      </div>
      <span className="inline-flex items-center rounded-full bg-white px-2 py-0.5 text-[10px] font-medium text-blue-700 border border-blue-200">
  ...
  return (
    <div className="flex flex-col min-h-full ">
      ...
      <main className="flex-1 px-6 pt-6 pb-16 space-y-6">
        {/* Celebration card */}
        <section className="rounded-[2.5rem] bg-orange-50/50 border border-orange-100/50 p-6 space-y-4 shadow-sm relative overflow-hidden group">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="inline-flex items-center rounded-lg bg-orange-100 px-2 py-0.5 text-[9px] font-black text-orange-700 w-fit uppercase tracking-wider">
                Elite Status
              </span>
