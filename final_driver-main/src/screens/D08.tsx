...
// EVzone Driver App – D08 Driver Personal – Document Under Review (v1)
// Shows that documents have been submitted and are awaiting verification.
        ...
        <header className="flex items-center justify-between px-4 pt-4 pb-2">
          <div className="flex items-center space-x-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e6fff7]">
              <Hourglass className="h-4 w-4 text-[#03cd8c]" />
            </div>
            <div className="flex flex-col items-start">
        ...
        <main className="flex-1 px-4 pb-4 space-y-4 overflow-y-auto scrollbar-hide">
          ...
          <section className="rounded-2xl bg-[#0b1e3a] text-white p-4 space-y-2">
            ...
            <p className="text-[11px] text-slate-100 leading-snug">
              Most verifications are completed within a few hours. You’ll
              receive a notification as soon as you’re approved or if we need
              more information.
            </p>
          </section>
